...
```{r}
my_sample <- "Ech2"
other_sample <- "Ech3" #un echantillon aléatoire qui n'est pas le votre

read.csv2("C:/Users/piosteil/Desktop/4-All_git/Cours/TP_Transcripto_N3S6/RNA-seq/count_table.csv", sep = ";", header = TRUE)
```