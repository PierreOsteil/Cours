...
2. [Analyse de données RT-qPCR avec R-Studio ](#Partie1)
    ...
    7. [Test statistiques](#Partie1.7)
    8. [Ploting des résultats](#Partie1.8)
...
Dans cette partie on va pouvoir générer des plots pour enfin connaître d'où provienne nos échantillons. Les données représentent 240 observations (12 échantillons par 20 gènes), nous allons pouvoir réalisé une PCA. 
```{r}

```

## 8. Test statistique <a name="Partie1.8"></a>
